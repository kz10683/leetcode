...
{
    /**
     * 198. You are a professional robber planning to rob houses along a street. Each house has a certain amount of
     * money
    ...
    public int rob(int[] nums)
    {
        ...
        // Create an array that tracks the max amount of money that can be obtained at each index/house
